...
$jobDir = $baseDir."/data/".$YEAR."/".$DATALabel."/EoP_".$CATType."_".$globeLabel."_".$MCGen."-".$runDepLabel."_".$ENCorrType."_".$DphiLabel.$mcClosureLabel.$mcHiggsLabel."/jobs/";
print("jobDir: ".$jobDir."\n");
...
#  print JOBSH "source /gwpool/initcms/slc5_64-gcc462-cmssw.sh\n"; 
  ...
  print JOBSH "unbuffer studyLinearity_EoP.exe ".$jobCfg." >& ".$jobOut."\n";
